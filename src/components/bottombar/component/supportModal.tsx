...
import { initializeIntercom, waitForIntercom } from './loadIntercomSdk';
...
const SupportModal = () => {
    ...
    const handleChatMessage = async (message: string) => {
        initializeIntercom(); // Ensure Intercom is initialized
    ...
    return (
        <div className="relative">
            ...
            {isModalOpen && (
                <div
                    className="absolute bottom-full right-[-1.2rem] mb-6 w-60 bg-white rounded-lg shadow-lg p-2 z-50 text-sm font-semibold"
                ...
                >
                    ...
                    >
                        Chat for Existing Orders
                    </button>
                    <Link className="flex items-center w-full px-2 py-2 hover:bg-gray-100 rounded"
