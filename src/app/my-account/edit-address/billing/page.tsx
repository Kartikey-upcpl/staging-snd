...
const EditBillingAddressDetails = () => {
    const searchParams = useSearchParams();
    const userDetails = searchParams.get("billing")
        ? JSON.parse(searchParams.get("billing") as string)
        : null;
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await updateUser(userId, { billing: formValues });
...
export default EditBillingAddressDetails
